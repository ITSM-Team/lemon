...
INSERT INTO AUTH_ROLE_DEF(ID,NAME,TENANT_ID) VALUES(3,'用户管理员','1');
...
INSERT INTO AUTH_ROLE_DEF(ID,NAME,TENANT_ID) VALUES(7,'组织管理员','1');
...
INSERT INTO AUTH_ROLE(ID,NAME,TENANT_ID,ROLE_DEF_ID) VALUES(3,'用户管理员',1,'3');
...
INSERT INTO AUTH_ROLE(ID,NAME,TENANT_ID,ROLE_DEF_ID) VALUES(7,'组织管理员',1,'7');
...
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(2,'module','myBpm','个人管理',NULL,2,NULL,201,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(21,'module','bpm','流程中心','/bpm/workspace-home.do',21,2,201,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(22,'module','report','统计报表','/report/index.do',22,2,202,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(3,'system','user','用户管理',NULL,3,NULL,301,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(31,'module','account','帐号管理','/user/account-info-list.do',31,3,301,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(32,'module','group','群组管理','/group/group-info-list.do',32,3,302,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(33,'module','auth','权限管理','/auth/user-status-list.do',33,3,303,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(4,'system','bpm','流程管理',NULL,4,NULL,401,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(41,'module','bpm','流程管理','/bpm/bpm-category-list.do',41,4,401,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(42,'module','task','任务管理','/humantask/task-info-list.do',42,4,402,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(43,'module','form','表单管理','/form/form-template-list.do',43,4,403,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(44,'module','model','模块管理','/model/model-info-list.do',44,4,404,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(5,'system','cms','内容管理',NULL,5,NULL,501,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(51,'module','cms','公告管理','/cms/cms-article-list.do',51,5,501,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(52,'module','cms','反馈管理','/feedback/feedback-info-list.do',52,5,502,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(6,'module','org','组织机构',NULL,6,NULL,601,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(61,'module','org','组织机构','/party/org-list.do',61,6,602,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(7,'system','system','系统配置',NULL,7,NULL,701,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(71,'module','system_menu','系统配置','/party/tree-list.do',71,7,701,'true');
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID,DISPLAY) VALUES(72,'module','system_notice','提醒配置','/sendmail/sendmail-config-list.do',72,7,702,'true');
