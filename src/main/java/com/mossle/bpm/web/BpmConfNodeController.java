...
//    @Autowired
//    private BpmConfNodeMongoService bpmConfNodeMongoService;
//    @Autowired 
...
//    	BpmConfBase bpmConfBase = bpmConfBaseMongoService.findById(bpmConfBaseId);
//    	Query query=new Query();
//    	query.addCriteria(Criteria.where("bpmConfBase").is(bpmConfBase));
//    	query.with(new Sort(Direction.ASC,"priority"));
//    	List<BpmConfNode> bpmConfNodes =bpmConfNodeMongoService.find(query);
