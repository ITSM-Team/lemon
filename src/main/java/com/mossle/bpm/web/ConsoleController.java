...
//            query.addCriteria(Criteria.where("processDefinitionId").is(processDefinition.getId())
//            		.orOperator(Criteria.where("processDefinitionKey").is(processDefinition.getKey())
//            				.and("processDefinitionVersion").is(processDefinition.getVersion())));
//            List<BpmConfBase> bpmConfBases = bpmConfBaseMongoService.find(query);
            ...
            for (BpmConfBase bpmConfBase : bpmConfBases) {
                ...
                // bpmConfBaseMongoService.remove(bpmConfBase.getId());
            }
        }
