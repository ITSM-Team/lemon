...
//        query.addCriteria(Criteria.where("bpmConfNode.bpmConfBase.processDefinitionId").is(processDefinitionId)
//        		.and("bpmConfNode.code").is(taskDefinitionKey));
//        List<BpmConfRule> bpmConfRules = ApplicationContextHelper
//                .getBean(BpmConfRuleMongoDao.class).find(query);
