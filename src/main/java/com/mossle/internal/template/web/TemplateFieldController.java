...
public class TemplateFieldController {
	...
	public String input(@RequestParam(value = "id", required = false) Long id,
			@RequestParam(value = "type", required = false) String whitelistTypeCode, Model model) {
		String tenantId = tenantHolder.getTenantId();
	...
	public String save(@ModelAttribute TemplateField templateField, @RequestParam("infoId") Long infoId,
	...
	//导出
	@RequestMapping("template-field-export")
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap,
		...
		List<TemplateField> feedbackInfos = (List<TemplateField>) page.getResult();

		TableModel tableModel = new TableModel();
		tableModel.setName("templateField");
		tableModel.addHeaders("id", "name","type","templateInfo.name");
