...
public class TemplateInfoController {
	...
	//导出
	@RequestMapping("template-info-export")
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap,
		...
		List<TemplateInfo> feedbackInfos = (List<TemplateInfo>) page.getResult();

		TableModel tableModel = new TableModel();
		tableModel.setName("templateInfo");
		tableModel.addHeaders("id", "name","code");
