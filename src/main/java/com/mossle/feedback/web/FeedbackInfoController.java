...
public class FeedbackInfoController {
	...
	public String save(@ModelAttribute FeedbackInfo feedbackInfo, RedirectAttributes redirectAttributes) {
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<FeedbackInfo> feedbackInfos = feedbackInfoManager.findByIds(selectedItem);
	...
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap,
		...
		List<FeedbackInfo> feedbackInfos = (List<FeedbackInfo>) page.getResult();

		TableModel tableModel = new TableModel();
		tableModel.setName("feedbackInfo");
		tableModel.addHeaders("id","feedbackCatalogname","time","feedbackPerson","status");
