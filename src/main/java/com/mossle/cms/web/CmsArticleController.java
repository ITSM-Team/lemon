...
public class CmsArticleController {
	...
	public String uploadImage(@RequestParam("CKEditorFuncNum") String callback,
		...
		String tenantId = tenantHolder.getTenantId();
		StoreDTO storeDto = storeConnector.saveStore("cms/html/r/images", new MultipartFileDataSource(attachment),
				tenantId);
	...
	public String upload(@RequestParam("id") Long id, @RequestParam("files[]") MultipartFile attachment)
			throws Exception {
		String tenantId = tenantHolder.getTenantId();
		StoreDTO storeDto = storeConnector.saveStore("cms/html/r/image", new MultipartFileDataSource(attachment),
				tenantId);
		CmsArticle cmsArticle = cmsArticleManager.get(id);
		CmsAttachment cmsAttachment = new CmsAttachment();
	...
	public String pdfArticle(@RequestParam(value = "id", required = false) Long id, Model model) {
		String tenantId = tenantHolder.getTenantId();
	...
	public String etcArticle(@RequestParam(value = "id", required = false) Long id, Model model) {
		String tenantId = tenantHolder.getTenantId();
