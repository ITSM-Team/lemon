...
<form id="smsQueueForm" method="post" action="sendsms-queue-save.do" class="form-horizontal">
  ...
  <div class="form-group">
    <label class="control-label col-md-2" for="smsQueue_sender">手机</label>
	<div class="col-sm-5">
	  <input id="smsQueue_sender" type="text" name="mobile" value="${model.mobile}" minlength="11" maxlength="11">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-md-2" for="smsQueue_data">信息</label>
	<div class="col-sm-5">
	  <textarea id="smsQueue_data" name="message" maxlength="70">${model.message}</textarea>
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-md-2" for="smsQueue_smsConfigId">短信服务器</label>
	<div class="col-sm-5">
