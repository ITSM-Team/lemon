		...
		<section id="m-main" class="col-md-10" style="padding-top: 65px;">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="glyphicon glyphicon-list"></i> 列表导航
				...
				<div class="panel-body">
					<ul class="nav nav-pills ">
						<c:forEach items="${modelInfos}" var="item">
							<li role="presentation"><a href="${tenantPrefix}/model/list.do?id=${item.id}"> <i class="glyphicon glyphicon-list"></i> ${item.name}
							</a></li>
						</c:forEach>
					</ul>
				</div>
			...
			<nav class="navbar navbar-default" role="navigation" id="queryBuilder">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav">
						<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> + 更多条件 <span class="caret"></span>
						</a>
