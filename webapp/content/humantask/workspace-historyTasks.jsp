						...
						<tbody>
							<c:forEach items="${page.result}" var="item">
								<tr>
									...
									<td>${item.name}</td>
									<td>完成</td>
									<td><a href="${tenantPrefix}/operation/task-operation-withdraw.do?humanTaskId=${item.id}&comment=">撤销</a> <a href="javascript:void(0);doTransfer(${item.id})">转发</a> <a href="${tenantPrefix}/bpm/workspace-viewHistory.do?processInstanceId=${item.processInstanceId}">详情</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
				...
				<div class="modal-body">
					<form>
						...
						<div class="input-group userPicker" style="width: 200px;">
							<input id="_assignee_key_" type="hidden" name="assignee" class="input-medium" value=""> <input type="text" class="form-control" name="username" placeholder="" value="">
